...
if __name__ == "__main__":
    ...
    baselines = ['VTC','DRR','LCF']
    acc_services_diffs = []
    for baseline in baselines:
        path = f"../{baseline}/all_results_poisson_short_long_2.jsonl"
        exps = []
    ...
    # plot
    plot(baselines, x_ticks, acc_services_diffs, "Time (s)", "Absolute Difference in Service", "sec5.2_overload_acc_service_diff")
