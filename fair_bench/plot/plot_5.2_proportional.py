...
if __name__ == "__main__":
    ...
    # plot
    plot(users, x_ticks, req_rate, "Time (s)", "Request Rate (token/s)", "sec5.2_proportional_req_rate")
    plot(users, x_ticks, throughput, "Time (s)", "Throughput (token/s)", "sec5.2_proportional_throughput")
    plot(users, x_ticks, service, "Time (s)", "Service (Token/s)", "sec5.2_proportional_service")
    plot(users, x_ticks, response_time, "Time (s)", "Response Time (s)", "sec5.2_propottional_response_time")
