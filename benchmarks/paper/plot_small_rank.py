...
def plot_num_adapter():
    ...
    y_names = ["Throughput (req/s)", "Average Latency (s)"]
    legends = ["S-LoRA", "S-LoRA-bmm", "S-LoRA-no-unify-mem"]
...
def plot_req_rate():
    x_name = "Request Rate"
    y_names = ["Throughput (req/s)", "First Token Latency (s)", "SLO Attainment"]
    legends = ["S-LoRA", "S-LoRA-bmm", "S-LoRA-no-unify-mem"]
