...
if __name__ == "__main__":
    ...
    parser.add_argument("--input", type=str, default="../all_results_increase.jsonl")
    ...
    # plot
    plot(users, x_ticks, req_rate, "Time (s)", "Request Rate (token/s)", "sec5.2_increase_req_rate")
    plot(users, x_ticks, throughput, "Time (s)", "Throughput (token/s)", "sec5.2_increase_throughput")
    plot(users, x_ticks, service, "Time (s)", "Service (/s)", "sec5.2_increase_service")
    plot(users, x_ticks, response_time, "Time (s)", "Response Time (s)", "sec5.2_increase_response_time")
