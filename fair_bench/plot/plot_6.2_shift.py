...
from visualize import (get_req_rate_over_time, get_throughput_over_time, get_service_over_time,
                       ...
                       FONTSIZE, MARKERSIZE, MARKERS, legend_x, legend_y, ylabel_x, ylabel_y)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--input", type=str, default="../all_results_dist_shift.jsonl")
    ...
    # plot
    plot(users, x_ticks, req_rate, "Time (s)", "Request Rate (token/s)", "sec6.2_dist_shift_req_rate")
    plot(users, x_ticks, throughput, "Time (s)", "Throughput (token/s)", "sec6.2_dist_shift_throughput")
    plot(users, x_ticks, service, "Time (s)", "Service (Token/s)", "sec6.2_dist_shift_service")
    plot(users, x_ticks, response_time, "Time (s)", "Response Time (s)", "sec6.2_dist_shift_response_time")
