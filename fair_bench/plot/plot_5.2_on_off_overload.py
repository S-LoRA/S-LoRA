...
if __name__ == "__main__":
    ...
    parser.add_argument("--input", type=str, default="../all_results_on_off_overload.jsonl")
    ...
    # plot
    plot(users, x_ticks, req_rate, "Time (s)", "Request Rate (token/s)", "sec5.2_on_off_overload_req_rate")
    plot(users, x_ticks, throughput, "Time (s)", "Throughput (Token/s)", "sec5.2_on_off_overload_throughput")
    plot(users, x_ticks, service, "Time (s)", "Service (Token/s)", "sec5.2_on_off_overload_service")
    plot(users, x_ticks, response_time, "Time (s)", "Response Time (s)", "sec5.2_on_off_overload_response_time")
